  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="text-gray-600">Guess the word between the top and bottom words!</p>
      </div>
      ...
      {message && (
        <div className={`text-center p-3 rounded-lg ${
          gameState.won ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
        }`}>
          {message}
        </div>
      )}
          ...
          {gameState.won && gameState.secretWord && (
            <div className="bg-green-100 border-2 border-green-300 rounded-lg p-4">
              ...
              <div className="text-sm text-green-700">
                The secret word was: <span className="font-mono font-bold uppercase">{gameState.secretWord}</span>
              </div>
      ...
      <Keyboard onKeyPress={handleKeyPress} disabled={isPending || gameState.completed} />
